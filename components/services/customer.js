				...
				<div class="container inner-top">
					...
					<div class="col-lg-1 inner-bottom-sm"></div>
						...
						<div class="col-lg-3 inner-bottom-sm">
							<!-- <h2>All in one</h2> -->
							<p class="text-small">Cine-Med is privileged to partner with healthcare teams to identify practice gaps and develop professional core competencies for targeted learners</p>
							<!-- <a href="#" class="txt-btn">View all possibilities</a> -->
						</div><!-- /.col -->
					
						<div class="col-lg-3 inner-bottom-sm">
							<!-- <h2>Mobile first</h2> -->
							<p class="text-small">Our focus is YOU. We have a vested interest in understanding your educational training goals and working with you to not only deliver on those goals, but to continue to evolve with your company in growing your brand and training programs.</p>

...
// User blocks
import { UserRegisterForm } from "./blocks/";
        ...
        <div className={ cx("bg-white-50") }>
          ...
          <Container ip={ Boolean(false) } mw="mw7">
            ...
            <div className={ cx("flex", "flex-column", "flex-row-ns", "items-center", "vh-100-ns", "mt6", "mt0-ns") }>
              <div className={ cx("fl", "w-100", "w-50-ns", "tc", "ph4") }>
                <h1 className={ cx("f3") }>Register For Free Trial</h1>
                <p className={ cx("lh-copy") }>Welcome to Business! Start your free trial now, no credit card required.</p>
              </div>

      ...
      <div className={ cx("ph4", "pv3", "black-80") }>
        <form className={ cx("measure", "center") }>
          <fieldset id="sign_up" className={ cx("ba", "b--transparent", "ph0", "mh0") }>
            <legend className={ cx("f4", "fw6", "ph0", "mh0", "dn") }>Create a new account</legend>
            <div className={ cx("mt3") }>
              <label className={ cx("db", "fw6", "lh-copy", "f6", "mb2") } htmlFor="name">Name</label>
              <input placeholder="Your name" className={ inputCL } type="text" name="name" id="name" />
            </div>
            <div className={ cx("mt3") }>
            ...
            <div className={ cx("mv3") }>
              <label className={ cx("db", "fw6", "lh-copy", "f6", "mb2") } htmlFor="confirm-password">Confirm Password</label>
              <input placeholder="" className={ inputCL } type="password" name="confirm-password" id="confirm-password" />
            </div>
            <p className={ cx("f6", "lh-copy") }>
              By registering you agree to the site&apos;s <Link className={ cx("blue", "pointer") }>terms & conditions.</Link>
            </p>
          </fieldset>
          <div>
            <button onClick={ this.formSubmitButton } className={ buttonCL }>Register</button>
          </div>
          <ul className={ cx("lh-copy", "mt3", "list", "pl0") }>
            <li><Link to="/login" className={ linkCL }>Have an account? Log in</Link></li>
          </ul>
        </form>
      </div>
    );
